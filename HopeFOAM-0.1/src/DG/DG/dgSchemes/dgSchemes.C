...
//TODO: set the steadyStateDdtScheme

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

int Foam::dgSchemes::debug(Foam::debug::debugSwitch("dgSchemes", false));
...
void Foam::dgSchemes::read(const dictionary& dict)
{
...
Foam::ITstream& Foam::dgSchemes::laplacianScheme(const word& name) const
{
    if (debug)
    {
