...
void Func                                                                      \
(                                                                              \
    GeometricDofField<ReturnType, PatchField, GeoMesh>& res,                      \
...
{                                                                              \
    tmp<GeometricDofField<ReturnType, PatchField, GeoMesh>> tRes                  \
    (                                                                          \
        new GeometricDofField<ReturnType, PatchField, GeoMesh>                    \
        (                                                                      \
            IOobject                                                           \
            (                                                                  \
                #Func "(" + gf1.name() + ')',                                  \
...
{                                                                              \
    ...
    tmp<GeometricDofField<ReturnType, PatchField, GeoMesh>> tRes                  \
    (                                                                          \
        reuseTmpGeometricDofField<ReturnType, Type1, PatchField, GeoMesh>::New    \
        (                                                                      \
            tgf1,                                                              \
            #Func "(" + gf1.name() + ')',                                      \
            Dfunc(gf1.dimensions())                                            \
...
{                                                                              \
    ...
    tmp<GeometricDofField<ReturnType, PatchField, GeoMesh>> tRes                  \
    (                                                                          \
        reuseTmpGeometricDofField<ReturnType, Type2, PatchField, GeoMesh>::New    \
        (                                                                      \
            tgf2,                                                              \
            #Func "(" + gf1.name() + ',' + gf2.name() + ')',                   \
            Func(gf1.dimensions(), gf2.dimensions())                           \
