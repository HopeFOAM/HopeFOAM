...
void stabilise
(
    GeometricDofField<scalar, PatchField, GeoMesh>& result,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf,
...
{
    tmp<GeometricDofField<scalar, PatchField, GeoMesh>> tRes
    (
...
tmp<GeometricDofField<scalar, PatchField, GeoMesh>> stabilise
(
    const tmp<GeometricDofField<scalar, PatchField, GeoMesh>>& tgsf,
    const dimensioned<scalar>& ds
)
{
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf = tgsf();
...
void pow
(
    GeometricDofField<scalar, PatchField, GeoMesh>& Pow,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf1,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf2
)
{
...
template<template<class> class PatchField, class GeoMesh>
tmp<GeometricDofField<scalar, PatchField, GeoMesh>> pow
(
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf1,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf2
)
{
    ...
    tmp<GeometricDofField<scalar, PatchField, GeoMesh>> tPow
    (
        new GeometricDofField<scalar, PatchField, GeoMesh>
        (
            IOobject
...
tmp<GeometricDofField<scalar, PatchField, GeoMesh>> pow
(
    const tmp<GeometricDofField<scalar, PatchField, GeoMesh>>& tgsf1,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf2
)
{
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf1 = tgsf1();
...
(
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf1,
    const tmp<GeometricDofField<scalar, PatchField, GeoMesh>>& tgsf2
)
{
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf2 = tgsf2();
...
void pow
(
    GeometricDofField<scalar, PatchField, GeoMesh>& tPow,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf,
    const dimensioned<scalar>& ds
)
{
...
void atan2
(
    GeometricDofField<scalar, PatchField, GeoMesh>& Atan2,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf1,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf2
)
{
...
template<template<class> class PatchField, class GeoMesh>
tmp<GeometricDofField<scalar, PatchField, GeoMesh>> atan2
(
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf1,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf2
)
{
    tmp<GeometricDofField<scalar, PatchField, GeoMesh>> tAtan2
    (
        new GeometricDofField<scalar, PatchField, GeoMesh>
        (
            IOobject
...
void atan2
(
    GeometricDofField<scalar, PatchField, GeoMesh>& tAtan2,
    const GeometricDofField<scalar, PatchField, GeoMesh>& gsf,
    const dimensioned<scalar>& ds
)
{
    ...
    {                                                                          \
        FatalErrorInFunction                                                   \
            ...
            << abort(FatalError);                                              \
                                                                               ...
                                                                               \
    tmp<GeometricDofField<scalar, PatchField, GeoMesh>> tFunc                     \
    (                                                                          \
        new GeometricDofField<scalar, PatchField, GeoMesh>                        \
        (                                                                      \
            IOobject                                                           \
